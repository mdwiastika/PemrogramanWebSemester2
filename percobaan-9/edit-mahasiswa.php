...
<body>
    ...
    ?>
    <form action="./post-edit-mahasiswa.php" method="post">
        ...
        <div class="row">
            ...
            <div class="">
                ...
                <input type="text" name="nama" value="<?= $row['nama'] ?>" id="nama" required>
            </div>
            <div class="">
                <label for="agama">Agama: </label>
                <input type="text" name="agama" value="<?= $row['agama'] ?>" id="agama" required>
            </div>
            <div class="">
                <label for="umur">Umur: </label>
                <input type="number" name="umur" value="<?= $row['umur'] ?>" id="umur" required>
            </div>
            <div class="">
